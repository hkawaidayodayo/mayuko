$(function(){
    ...
    let aryList =
  [
    '株式会社vaiyabai','恋愛について論じてみな！','少子高齢化について','私が思う最強のビジネスについて',
    '人生の目標について','己を変える！','すごい最新技術！','意思決定について論じる','マジで言いたい事がある',
    'グミ川について考えた','笠原とは！彼について','nodejsについて','世界を変える発明について','半年後の私について'
  ];
